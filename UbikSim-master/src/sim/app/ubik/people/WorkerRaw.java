...
/**
 * WorkerRaw person example: uses the pathfinding (as a thread) to reach a random exit (assumed rooms with names
 ...
 Moreover, the environment has to include an object WorkerRaw. It has been tested with mapExample.ubiksim.
 Agents get out after reaching a goal
 *
 * @author Emilio Serrano, Ph.d.; eserrano [at] gsi.dit.upm.es
 */
public class WorkerRaw extends  Person{
    private static final Logger LOG = Logger.getLogger(WorkerRaw.class.getName());
    ...
    public WorkerRaw(int floor, HomePieceOfFurniture person3DModel, Ubik ubik) {
    ...
    public static void setGlobalGoal(String globalGoal) {
        WorkerRaw.globalGoal = globalGoal;
